...
- Native desktop application in `seating-gui-egui` with structured editors for people, closeness rules, tables, optimization controls, seating-plan rendering, and CSV import/export.
